...
<a id="rqmd-init-001"></a>

### RQMD-INIT-001: Agent-driven bundle bootstrap chat
...
<a id="rqmd-init-002"></a>

### RQMD-INIT-002: Legacy-repo init skill and workflow
...
<a id="rqmd-init-003"></a>

### RQMD-INIT-003: Useful first-pass requirements folder for legacy repos
...
<a id="rqmd-init-004"></a>

### RQMD-INIT-004: Optional GitHub issue discovery during legacy init
...
<a id="rqmd-init-005"></a>

### RQMD-INIT-005: Init-chat AI handoff prompt generation
...
<a id="rqmd-init-006"></a>

### RQMD-INIT-006: Concise copy/paste init prompt UX
...
<a id="rqmd-init-007"></a>

### RQMD-INIT-007: Unified init workflow with heuristic routing
...
<a id="rqmd-init-008"></a>

### RQMD-INIT-008: Explicit legacy-init compatibility and override flag
...
<a id="rqmd-init-009"></a>

### RQMD-INIT-009: Chat-first init entrypoint for new projects
...
<a id="rqmd-init-010"></a>

### RQMD-INIT-010: Default init guidance favors AI chat flow
...
<a id="rqmd-init-011"></a>

### RQMD-INIT-011: Init interview recommends a project-specific ID prefix
...
<a id="rqmd-init-012"></a>

### RQMD-INIT-012: Init interview exposes default-checked suggested choices
...
<a id="rqmd-init-013"></a>

### RQMD-INIT-013: Explicit interactive interview contract for receiving agents
...
<a id="rqmd-init-014"></a>

### RQMD-INIT-014: Legacy-init installs local schema guidance into generated requirement indexes
...
<a id="rqmd-init-015"></a>

### RQMD-INIT-015: `rqmd-init` scaffolds a `/release` skill during the interview
...
<a id="rqmd-init-016"></a>

### RQMD-INIT-016: `rqmd-init` generates a `release.sh` stub for repos without a canonical release command
