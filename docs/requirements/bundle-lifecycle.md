...
<a id="rqmd-bundle-001"></a>

### RQMD-BUNDLE-001: Installable AI agent/skill instruction bundle
...
<a id="rqmd-bundle-002"></a>

### RQMD-BUNDLE-002: Resource-backed AI UX source of truth
...
<a id="rqmd-bundle-003"></a>

### RQMD-BUNDLE-003: Default bundled skill-definition export when bundle is absent
...
<a id="rqmd-bundle-004"></a>

### RQMD-BUNDLE-004: Bundle-aware suppression of duplicate default skill exports
...
<a id="rqmd-bundle-005"></a>

### RQMD-BUNDLE-005: Workspace bundle provenance and refresh metadata
...
<a id="rqmd-bundle-006"></a>

### RQMD-BUNDLE-006: Single-agent-first bundle install defaults with explicit reinstall/upgrade commands
...
<a id="rqmd-bundle-007"></a>

### RQMD-BUNDLE-007: Agent instructions auto-fix metadata mismatch
...
<a id="rqmd-bundle-008"></a>

### RQMD-BUNDLE-008: Preflight step auto-syncs stale index metadata
...
- Given the repository has an `agent-workflow.sh` with a `preflight` subcommand (RQMD-AI-EXEC-004/006)
...
<a id="rqmd-bundle-009"></a>

### RQMD-BUNDLE-009: `/rqmd-release` skill — universal release guardrails
