...
<a id="rqmd-prompt-001"></a>

### RQMD-PROMPT-001: Long-running priority-first development agent

- **Status:** 🗑️ Deprecated
- **Priority:** 🟠 P1 - High
- **Superseded by:** RQMD-PROMPT-005
...
<a id="rqmd-prompt-002"></a>

### RQMD-PROMPT-002: Easy-first low-hanging-fruit development agent
...
<a id="rqmd-prompt-003"></a>

### RQMD-PROMPT-003: Prompt-first single-agent bundle entrypoints
...
<a id="rqmd-prompt-004"></a>

### RQMD-PROMPT-004: Installed prompt suite for common rqmd actions
...
<a id="rqmd-prompt-005"></a>

### RQMD-PROMPT-005: Count-aware go prompts and commit-per-slice variant
...
<a id="rqmd-prompt-006"></a>

### RQMD-PROMPT-006: Rename primary agent from `rqmd-dev` to `rqmd`
...
<a id="rqmd-prompt-007"></a>

### RQMD-PROMPT-007: `/bug` prompt for quick bug filing from chat context
