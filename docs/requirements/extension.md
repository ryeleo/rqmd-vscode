...
### RQMD-VSCODE-001: Distribute rqmd AI bundle as a VS Code extension
...
<a id="rqmd-vscode-002"></a>

### RQMD-VSCODE-002: VS Code extension project scaffolding via command palette

- **Status:** 🔧 Implemented
- **Priority:** 🟡 P2 - Medium
- **Blocked by:** RQMD-VSCODE-001
...
<a id="rqmd-vscode-003"></a>

### RQMD-VSCODE-003: Register @rqmd chat participant for unified command surface
...
<a id="rqmd-vscode-004"></a>

### RQMD-VSCODE-004: Migrate /prompts to @rqmd subcommands

- **Status:** 💡 Proposed
- **Priority:** 🟡 P2 - Medium
- **Blocked by:** RQMD-VSCODE-003
...
<a id="rqmd-vscode-005"></a>

### RQMD-VSCODE-005: Skills hidden from user autocomplete via user-invocable flag
...
<a id="rqmd-vscode-006"></a>

### RQMD-VSCODE-006: Same-major rqmd auto-install version policy
...
<a id="rqmd-vscode-008"></a>

### RQMD-VSCODE-008: Unified shim bootstrap entrypoint for all rqmd invocations

- **Status:** 🔧 Implemented
- **Priority:** 🟠 P1 - High
- **Blocked by:** RQMD-VSCODE-007
...
<a id="rqmd-vscode-009"></a>

### RQMD-VSCODE-009: Bootstrap install lock and session debounce

- **Status:** 🔧 Implemented
- **Priority:** 🟡 P2 - Medium
- **Blocked by:** RQMD-VSCODE-008
...
<a id="rqmd-vscode-010"></a>

### RQMD-VSCODE-010: Bootstrap reason-code telemetry and diagnostics
...
<a id="rqmd-vscode-011"></a>

### RQMD-VSCODE-011: Extension icon for marketplace and chat mode picker
